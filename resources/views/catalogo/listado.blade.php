...
<body style="background-color: #fed7ee;">
                ...
                @foreach ($products as $product)
                    ...
                    <div
                        ...
                        <div class="h-56 w-full">
                            <a href="/catalogo/detalle/{{ $product->id }}">
                        ...
                        <div class="pt-6">
                            <div class="mb-4 flex items-center justify-between gap-4">
                                <span
                                    class="me-2 rounded bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300">{{ $product->category }}</span>
                            ...
                            <a href="/catalogo/detalle/{{ $product->id }}"
                                class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $product->title }}</a>
                            <p
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $product->rating->rate }}
                                </p>
            ...
            <div class="relative h-full w-full max-w-xl md:h-auto">
                ...
                <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                    ...
                    <div class="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
                        <button type="submit"
                            class="rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-800">Show
                            50 results</button>
                        <button type="reset"
